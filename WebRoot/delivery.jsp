...
<title>我的投递记录-招聘服务-求职招聘网-最专业的互联网招聘平台</title>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
	    		...
	    		<li v-else-if="ident == 0" class="current"><a href="delivery.jsp" rel="nofollow">投递箱</a></li>
	    						    		</ul>
        ...
        <div class="clearfix">
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset" id="tab1">
                    			<li class="current">
                    				<a   @click="getDelivery(-1)">全部</a>
                    			</li>
                    			 
                    			<li>
                    				<a   @click="getDelivery(0)" >等待回应</a>
                    			</li>
                    			<li>
                    				<a   @click="getDelivery(1)" >通知面试</a>
                    			</li>
                    			<li class="last">
                    				<a   @click="getDelivery(2)">不合适</a>
                    			</li>
                    		</ul>
                    	</div>
                            ...
                            <ul class="reset my_delivery">
                               	 <li v-for="item in List">
                             		<div class="d_item">
	                                        ...
	                                        <a target="_blank"  >
	                                        	<em>{{item.c3Name}}</em> 
	                                        	<span>（{{item.salarybegin}}k-{{item.salaryend}}k）</span>
	                                        	<!--  -->
	                                    	</a>
	                                    </h2>
	                                    		                                <div class="clear"></div>
	                                   	<a title="公司名称" class="d_jobname" target="_blank" href=" #">
	                                   		{{item.companyName}} <span>[{{item.jobcity}}]</span> 
	                                    </a>
	                                    <span class="d_time">{{item.begintime}}</span>
	                                    <div class="clear"></div>
	                                    <div class="d_resume">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
                	...
                	<img width="242" height="242" alt="求职招聘微信公众号二维码" src="style/images/qr_delivery.png">
                    <span class="c7">扫描求职招聘二维码，微信轻松搜工作</span>
                </div>
            </div>
       	</div>
    ...
    var deliveryvue=new Vue({
        ...
        methods:{
           ...
           pageHandler:function(page ){
	           this.page=page;
	           var params={"status":this.status,'personid': this.person.personid,"page": this.page,"row":this.pageSize};
	           this.$http.post("getDelivery.do",params,{emulateJSON:true}).then(
	              function(res){

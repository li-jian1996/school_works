            	...
            	<dl class="company_center_content">
                    ...
                    <form id="searchForm">
			                	...
			                	<ul class="reset my_jobs">
				                		 <li data-id="149594" v-for="(item,index) in jobList">
		                                    <h3>
		                                        <a target="_blank"     >    {{item.c3Name}}   </a> 
    ...
    var positionsvue2=new Vue({
        ...
        methods:{
           ...
           pageHandler:function(page){
	           this.page=page;
	           var params={'companyid': this.company.companyid,"state":2,"page": this.page,"row":this.pageSize};

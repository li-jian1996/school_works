	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
	    		...
	    		<li v-if="ident == 1" class="current"><a href="create.jsp" rel="nofollow">发布职位</a></li>
                    	...
                    	<form action=" " method="post" id="jobForm">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td>
                                        ...
                                        <input type="button"  id="select_category"   class="selectr selectr_380">                                      
                                        <div class="dn" id="box_job" style="display: none;">
                                              <dl   v-for="item1  in jobc1c2c3">
                                                    <dt >{{item1.c1name}}</dt>
                                                    <dd>
                                                        <ul class="reset job_main">
                                                                  <li v-for="item2  in item1.jobc2PojoList">
                                                                    <span>{{item2.c2name}}</span>
                                                                           <ul class="reset job_sub dn">
                                                                                 <li  v-for="item3  in item2.jobc3List"  @click="getC3id(item3.c3id)">{{item3.c3name}}</li>
                                                                           </ul>
                                                                  </li>
                                                        </ul>
                                                    </dd>
                            	...
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：产品经理"  name="positionName" id="positionName">
                                    	                                    </td>
                                </tr>
                            	<tr>
                                	<td></td>
                                	<td>所属部门</td>
                                	<td>
                                    	<input type="text" placeholder="请输入所属部门"   v-model="job.departments" name="department" id="department">	
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作性质</td>
                                	<td>
                                    	 <select name="" id="" v-model="job.worktype"  style="-webkit-appearance: none;appearance: none;" class="selectr selectr_380" >
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最低月薪" v-model="job.salarybegin" id="salaryMin" name="salaryMin"> 
                                                <span>k</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="最高月薪" v-model="job.salaryend" id="salaryMax" name="salaryMax"> 
                                                <span>k</span>
                                            </div>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" v-model="job.jobcity" name="workAddress" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td>
                                    	<input type="hidden" id="experience" value="" name="workYear">
                                          ...
                                          <select name="" id="" v-model="job.jobexperience "  style="-webkit-appearance: none;appearance: none;" class="selectr selectr_380" >
                            	...
                            	<tr>
                                	...
                                	<td>
                                        ...
                                        <select name="" id="" v-model="job.education"  style="-webkit-appearance: none;appearance: none;" class="selectr selectr_380" >
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" v-model="job.jobtemptation" name="positionAdvantage" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                	...
                                	<td>
                                    	...
                                    	<textarea v-model="job.jobdescribe"></textarea>
                                       <!-- <textarea name="positionDetail" id="positionDetail" class="tinymce" style="display: none;" aria-hidden="true">
                                        </textarea>
                                ...
                                <tr>
                                	...
                                	<td>工作地址</td>
                                	<td>
                                    	<input type="text" placeholder="请输入详细的工作地址" v-model="job.jobaddress" name="positionAddress" class="input_520" id="positionAddress">	
                            ...
                            <table>
                            	<tbody><tr>
                                	<td width="25"><span class="redstar">*</span></td>
                                	<td colspan="2">
                                    	接收简历邮箱：<input type="text" placeholder="请输入详细的工作地址" v-model="job.jobemail"    id="receiveEmailVal">	
                                ...
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2">
                                    	<input type="button" value="发布"  @click="insertJob()"  class="btn_32">
                                    </td>
                                </tr>
                         	</tbody></table>
                        </form>
...
<script type="text/javascript">
    ...
    var createvue=new Vue({
        ...
        watch:{
        	job: {
	                ...
	                handler(val, oldVal){
			               ...
			               console.log(this.job.c3id+"#"+this.job.companyid+"#"+this.job.departments+"#"+this.job.jobcity+"#"+this.job.jobexperience+"#"+this.job.jobdescribe)
			         },
		        	  deep:true
        ...
        created:function(){
        	...
        	var  jobid1=  getQueryString("jobid");
        	if(jobid1!=''||jobid1!=null){
        		this.$http.post("getJobByJobId.do",   //获得公司信息
                	{'jobid1': jobid1},{emulateJSON:true}).then(
        			function(res){
            			this.job=res.data;
        			},
        			function(res){
